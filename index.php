    ...
    <section class="device-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL; ?>device-search.php" method="POST">
                <input type="search" name="search" placeholder="Search for Laptop.." required>
    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore Laptops</h2>
            ...
            <?php 
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>category-device.php?category_id=<?php echo $id; ?>">
                            <div class="box-3 float-container">
                                <?php 
                                    ...
                                    else
                                    {
                                        //Image Available
                                        ?>
                                        <img src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="Laptop" class="img-responsive img-curve">
                                        <?php
                                    }
                                ?>
    ...
    <section class="device-menu">
        <div class="container">
            ...
            //Getting devicess from Database that are active and featured
            //SQL Query
            $sql2 = "SELECT * FROM tbl_device WHERE active='Yes' AND featured='Yes' LIMIT 6";
            ...
            //CHeck whether device available or not
            if($count2>0)
            {
                //Food Available
            ...
            {
                //Food Not Available 
                echo "<div class='error'>Device not available.</div>";
            }
        ...
        <p class="text-center">
            <a href="<?php echo SITEURL; ?>device.php">See All Laptops</a>
        </p>
    </section>
